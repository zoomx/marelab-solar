...
src/json/%.o: ../src/json/%.c
	...
	/mnt/arm-tool/arm-2011.09/bin/arm-none-linux-gnueabi-gcc -D_REENTRANT -O3 -Wall -c -fmessage-length=0 -march=armv4t -mtune=arm920t -pthread -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
